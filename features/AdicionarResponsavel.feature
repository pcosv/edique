Feature: parking space reminder
	...
	@ignore
 	Scenario: Adicionar responsável a atividade ociosa (Sistema)
		...
		When eu adiciono "Robertson" como responsável da atividade "Preparar palestra"
		Then a atividade "Preparar palestra" tem "Robertson" como responsável
	...
	@ignore
 	Scenario: Scenario: Adicionar responsável a atividade (GUI)
		...
		And eu seleciono o usuário "Robertson" como responsável da atividade "Preparar palestra"
		Then eu vejo o usuário "Robertson" como responsável da atividade "Preparar palestra" 
